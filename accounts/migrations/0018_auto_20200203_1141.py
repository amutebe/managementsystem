...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0017_auto_20200131_1825'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='car',
            name='car_number',
            field=models.CharField(default='030220201545', max_length=200, primary_key=True, serialize=False, verbose_name='Corrective action no.:'),
        ),
        migrations.AlterField(
            model_name='car',
            name='status',
