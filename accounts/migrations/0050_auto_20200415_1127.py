...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0049_auto_20200415_1043'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='car',
            name='car_number',
            field=models.CharField(default='TEGA1504202096', max_length=200, primary_key=True, serialize=False, verbose_name='Corrective action no.:'),
        ),
        migrations.AlterField(
            model_name='car',
            name='status',
