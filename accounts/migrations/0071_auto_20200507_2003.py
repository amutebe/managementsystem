...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0070_auto_20200507_2000'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='car',
            name='car_number',
            field=models.CharField(default='TEGA07052020966', max_length=200, primary_key=True, serialize=False, verbose_name='Corrective action no.:'),
        ),
        migrations.AlterField(
            model_name='car',
            name='status',
