...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0078_auto_20200510_2026'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='car',
            name='car_number',
            field=models.CharField(default='TEGA10052020291', max_length=200, primary_key=True, serialize=False, verbose_name='Corrective action no.:'),
        ),
        migrations.AlterField(
            model_name='car',
            name='status',
